...
template [[host_name("kernel_mul_mm_q8_0_f16_pairs")]] kernel mul_mm_t kernel_mul_mm<32, half, half4x4, simdgroup_half8x8, half, half2x4, simdgroup_half8x8, block_q8_0, 2, dequantize_q8_0_pairs, float, float4x4, half, half2x4>;
