...
ifeq ($(UNAME_S),Darwin)
.PHONY: metal-decode-schedule-bench metal-prefill-variant-bench metal-q8-prefill-bench check-mxfp4-half-lut
...
help:
	...
	@echo "  make metal-q8-prefill-bench  Build the dense Q8 prefill kernel benchmark"
...
speed-bench/metal_q8_prefill_bench.o: speed-bench/metal_q8_prefill_bench.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

speed-bench/metal_q8_prefill_bench: speed-bench/metal_q8_prefill_bench.o ds4_metal.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

metal-q8-prefill-bench: speed-bench/metal_q8_prefill_bench
...
tests/qwen_session_smoke.o: tests/qwen_session_smoke.c ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/qwen_session_smoke: tests/qwen_session_smoke.o ds4_cpu.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
