...
/* Evaluate `token` and return the sampled next token.  Metal builds may skip
 * materializing host logits when a DS4_FUSED_SAMPLE_* gate is enabled. */
int ds4_session_eval_sample_next(ds4_session *s, int token,
